    ...
    <Card className="p-6">
      ...
      <Tabs defaultValue="weekly" className="space-y-6">
        ...
        <TabsContent value="weekly" className="space-y-6">
          <div>
            <h3 className="text-lg font-semibold mb-4">Words Learned This Week</h3>
            <ChartContainer
              config={{
                words: {
                  label: "Words",
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4">Reading Time (minutes)</h3>
            <ChartContainer
              config={{
                minutes: {
                  label: "Minutes",
            ...
            >
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={monthlyData}>
                  ...
                  <ChartTooltip content={<ChartTooltipContent />} />
                  <Bar dataKey="words" fill="hsl(var(--primary))" radius={[8, 8, 0, 0]} />
                  <Bar dataKey="texts" fill="hsl(var(--accent))" radius={[8, 8, 0, 0]} />
                </BarChart>
              </ResponsiveContainer>
            </ChartContainer>
          </div>
        ...
        <TabsContent value="languages" className="space-y-4">
          <h3 className="text-lg font-semibold mb-4">Progress by Language</h3>
          {languageData.map((lang) => (
            <div key={lang.language} className="space-y-2">
              <div className="flex items-center justify-between">
                <span className="font-medium">{lang.language}</span>
                <span className="text-sm text-muted-foreground">{lang.words} words</span>
              </div>
